<nav class="flex-grow flex flex-col pt-5 pb-4 overflow-y-auto">
                    ...
                    <a href="{{ route('resources.vpilot-acars') }}"
                       ...
                       class="flex items-center justify-between px-2.5 py-1.5 rounded text-xs font-medium transition-colors opacity-80 hover:opacity-100 hover:bg-black/10 group">
                        <span class="flex items-center gap-1.5">
                            ...
                            <span>Download V-AirOps ACARS</span>
                        </span>
    ...
    <div class="px-5 py-3 border-t border-black/20 text-[10px] font-mono flex items-center justify-between opacity-80">
        <button type="button" onclick="if(window.openCookieSettings) window.openCookieSettings();" class="hover:text-amber-400 text-slate-400 transition flex items-center gap-1 text-[9px] uppercase tracking-wider font-semibold focus:outline-none" title="Cookie & Privacy Preferences">
