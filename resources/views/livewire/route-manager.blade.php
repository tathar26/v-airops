    ...
    <div class="glass-panel overflow-hidden mt-6">
        <div class="px-6 py-5 border-b border-white/10 flex justify-between items-center flex-wrap gap-4">
            ...
            <div class="flex items-center gap-3">
                ...
                <a href="{{ route('global-network') }}" class="bg-[#212631] border border-tenant-accent text-tenant-accent px-4 py-2 rounded-md text-sm font-semibold shadow-sm hover:opacity-90 transition mr-2 flex items-center gap-2">
