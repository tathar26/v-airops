<div class="max-w-7xl mx-auto py-10 sm:px-6 lg:px-8 space-y-6">
    ...
    <div class="bg-[#12161F] border border-white/10 rounded-xl overflow-hidden shadow-xl">
        <div class="px-6 py-3.5 bg-[#181D29] border-b border-tenant-accent/40 border-t-2 text-xs text-gray-400 font-bold tracking-wider flex justify-between items-center">
            <span>FLIGHT LOGBOOK HISTORY</span>
            <span class="text-xs text-gray-400 font-mono font-semibold">Total Logged: {{ count($pireps) }} PIREPs</span>
        </div>
            ...
            <table class="min-w-full divide-y divide-white/5">
                <thead class="bg-[#181D29]">
                    <tr>
                        ...
                        <th class="px-6 py-3.5 text-right text-xs font-semibold text-gray-400 tracking-wider">Details</th>
                    </tr>
                </thead>
                <tbody class="divide-y divide-white/5 bg-[#12161F]">
                    ...
                    <tr class="hover:bg-white/5 transition-colors">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <a href="{{ route('profile.pireps.show', $pirep->id) }}" class="text-tenant-accent hover:text-white transition-colors bg-white/5 hover:bg-tenant-accent px-3 py-1.5 rounded-lg text-xs font-bold border border-white/10 inline-flex items-center gap-1">
                                View
                            </a>
                        </td>
                    </tr>
