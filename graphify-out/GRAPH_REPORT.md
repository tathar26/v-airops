...
## Corpus Check
- 358 files · ~200,101 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1782 nodes · 3101 edges · 284 communities (79 shown, 74 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 15 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a3977ab2`
...
## Communities (284 total, 74 thin omitted)
...
Cohesion: 0.12
Nodes (10): AcarsPosition, ScoringCriteria, SystemGlobalAircraft, SystemGlobalAirframe, SystemGlobalAirline, SystemGlobalAirport, SystemGlobalFlight, BelongsToTenant (+2 more)

### Community 8 - "Livewire\Component"
Cohesion: 0.10
Nodes (7): AccountSettings, Awards, Map, PirepDetail, TenantSettings, Livewire\Component, Livewire\WithFileUploads
...
### Community 12 - "UserAirline"
Cohesion: 0.12
Nodes (4): WithTenantUserManagement, UserAirline, UserAirlineRole, Illuminate\Database\Eloquent\Relations\Pivot
...
### Community 14 - "Tenant"
Cohesion: 0.11
Nodes (5): WithTenantScoringSettings, HasAirlineNotams, Collection, Tenant, Illuminate\Database\Eloquent\Collection

### Community 17 - "WithTenantRolesAndPermissions"
Cohesion: 0.07
Nodes (7): WithTenantRolesAndPermissions, AirlinePermission, AirlineRole, App\Models\Team, UserFactory, Illuminate\Database\Eloquent\Factories\Factory, static
...
Cohesion: 0.09
Nodes (19): CreateNewUser, PasswordValidationRules, ResetUserPassword, UpdateUserPassword, UpdateUserProfileInformation, Illuminate\Cache\RateLimiting\Limit, Illuminate\Contracts\Auth\MustVerifyEmail, Illuminate\Support\Facades\Hash (+11 more)
...
Cohesion: 0.17
Nodes (5): Dashboard, TenantDashboard, VersionService, Illuminate\Support\Facades\Auth, Illuminate\Support\Facades\Cache
...
### Community 47 - "CustomAuthController"
Cohesion: 0.17
Nodes (3): CustomAuthController, Illuminate\Contracts\Validation\Rule, Illuminate\Validation\Rules\Password
...
### Community 62 - "Airport"
Cohesion: 0.18
Nodes (3): Airport, Illuminate\Support\Facades\Http, Illuminate\Support\Facades\Storage
...
Cohesion: 0.16
Nodes (4): AcarsController, TelemetryPingRequest, AcarsActiveFlight, Illuminate\Database\Eloquent\Relations\HasOne
...
Cohesion: 0.19
Nodes (4): AuthController, FlightController, LoginRequest, Illuminate\Http\JsonResponse
...
Cohesion: 0.19
Nodes (4): DispatchFlightRequest, FlightEventRequest, PirepSubmitRequest, Illuminate\Foundation\Http\FormRequest
...
Cohesion: 0.18
Nodes (4): AcarsController, FlightCentreApiController, SessionAirlineController, Illuminate\Http\Request
...
## Knowledge Gaps
- **338 isolated node(s):** `$schema`, `name`, `type`, `description`, `keywords` (+333 more)
...
- **Why does `User` connect `User` to `TenantHub`, `Illuminate\Database\Eloquent\Relations\BelongsTo`, `TestCase`, `EmailVerificationTest.php`, `Illuminate\Database\Eloquent\Model`, `Livewire\Component`, `UserAirline`, `Tenant`, `WithTenantRolesAndPermissions`, `HasPilotRanks`, `RecalculatePilotStatistics`, `FortifyServiceProvider.php`, `Dispatch`, `RankProgressionService`, `Notam`, `HasTenantContext`, `Preferences.php`, `HasAirlineRolesAndPermissions`, `PasswordResetTest.php`, `CustomAuthController`, `Illuminate\Support\ServiceProvider`, `Illuminate\Database\Eloquent\Builder`, `Airport`, `AcarsActiveFlight`, `MasterAdminDashboard`, `AcarsApiTest.php`, `DemoDashboardSeeder.php`, `Illuminate\Http\JsonResponse`, `UpdatePasswordTest`, `PasswordConfirmationTest`?**
  _High betweenness centrality (0.140) - this node is a cross-community bridge._
- **Why does `Tenant` connect `Tenant` to `TenantHub`, `User`, `TestCase`, `Illuminate\Database\Eloquent\Model`, `Livewire\Component`, `UserAirline`, `Pirep`, `Illuminate\Database\Eloquent\Relations\HasMany`, `Rank`, `WithTenantRolesAndPermissions`, `HasPilotRanks`, `RecalculatePilotStatistics`, `HasCallsignMappings`, `RankProgressionService`, `Booking`, `HasTenantContext`, `ScheduleImportService`, `PirepController.php`, `HasAirlineRolesAndPermissions`, `Illuminate\Database\Eloquent\Builder`, `GlobalNetworkImport`, `CallsignGeneratorService`, `WithTenantGeneralSettings`, `Airport`, `MasterAdminDashboard`, `AcarsApiTest.php`, `DemoDashboardSeeder.php`, `Illuminate\Http\Request`?**
  _High betweenness centrality (0.073) - this node is a cross-community bridge._
- **Why does `Pirep` connect `Pirep` to `Illuminate\Http\Request`, `Livewire\WithPagination`, `MasterAdminDashboard`, `PilotProfile`, `TenantHub`, `DemoDashboardSeeder.php`, `Illuminate\Database\Eloquent\Model`, `Livewire\Component`, `PirepController.php`, `Preferences.php`, `HasAirlineRolesAndPermissions`, `RecalculatePilotStatistics`, `UserStatistic`, `RankProgressionService`, `Booking`?**
