...
### Community 6 - "TwoFactorAuthenticationSettingsTest.php"
Cohesion: 0.15
...
### Community 47 - "Illuminate\Support\Facades\Hash"
Cohesion: 0.20
...
### Community 76 - "FortifyServiceProvider.php"
Cohesion: 0.13
...
- **Why does `User` connect `User` to `TenantHub`, `Illuminate\Database\Eloquent\Relations\BelongsTo`, `TestCase`, `TwoFactorAuthenticationSettingsTest.php`, `Illuminate\Database\Eloquent\Model`, `Livewire\Component`, `AircraftType`, `UserAirlineRole`, `Tenant`, `Notam.php`, `HasAirlineNotams`, `WithTenantRolesAndPermissions`, `HasPilotRanks`, `RecalculatePilotStatistics`, `CreateNewUser.php`, `Dispatch`, `ProfileInformationTest.php`, `RankProgressionService`, `Notam`, `HasTenantContext`, `Airport`, `Preferences.php`, `AirlineRole`, `PasswordResetTest.php`, `Illuminate\Support\Facades\Hash`, `JetstreamServiceProvider`, `Activity`, `ActivityRegistration`, `AcarsActiveFlight`, `MasterAdminDashboard`, `Carbon`, `DemoDataSeeder.php`, `Illuminate\Http\JsonResponse`, `FortifyServiceProvider.php`, `UpdatePasswordTest.php`, `Illuminate\Http\Request`, `ActivitySystemTest`?**
  _High betweenness centrality (0.109) - this node is a cross-community bridge._
- **Why does `Tenant` connect `Tenant` to `TenantHub`, `PilotProfile`, `User`, `TestCase`, `Illuminate\Database\Eloquent\Model`, `Livewire\Component`, `AircraftType`, `HasAirlineNotams`, `Rank`, `WithTenantRolesAndPermissions`, `HasPilotRanks`, `RecalculatePilotStatistics`, `HasCallsignMappings`, `RankProgressionService`, `Booking`, `HasTenantContext`, `ScheduleImportService`, `Preferences.php`, `AirlineRole`, `Illuminate\Support\Facades\Hash`, `Activity`, `GlobalNetworkImport`, `CallsignGeneratorService`, `ActivityRegistration`, `AcarsActiveFlight`, `MasterAdminDashboard`, `Carbon`, `DemoDataSeeder.php`, `ActivitySystemTest`?**
  _High betweenness centrality (0.070) - this node is a cross-community bridge._
- **Why does `Pirep` connect `Pirep` to `TenantHub`, `PilotProfile`, `Illuminate\Database\Eloquent\Model`, `Livewire\Component`, `.processPirep`, `Tenant`, `Rank`, `RecalculatePilotStatistics`, `Airframe`, `PirepDetail`, `RankProgressionService`, `Booking`, `PirepsList`, `.submit`, `Preferences.php`, `AirlineRole`, `UserStatistic`, `ActivityRegistration`, `AcarsActiveFlight`, `MasterAdminDashboard`, `Carbon`, `Carbon\Carbon`, `Illuminate\Http\Request`, `ActivitySystemTest`?**
